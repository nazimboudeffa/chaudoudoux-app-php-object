...
.bgimg {
  background-image: url('images/alex-blajan-ThC_2PV783A-unsplash.jpg');
  min-height: 100%;
...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
  ...
  <div class="w3-display-middle">
    ...
    -->
    <p class="w3-large w3-center"><a href="home.php" class="w3-button w3-pink">Entrer</a></p>
  </div>
